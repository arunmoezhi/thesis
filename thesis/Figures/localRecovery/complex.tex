...
\centering
{
	\begin{tikzpicture}[scale=\myfigurescale, transform shape]
		...
		\node (o)		[subtree] 									at (-5.5,-5.5)  {\Large $\delta$};
		...
		(-3.25, 0) edge[->,semithick, double] node [above, outer sep=3pt] {\large \textsf{delete} 50} (-0.75, 0);
		...
		\node (io)	[subtree]										at (0,-4)				{\Large $\delta$}; 
