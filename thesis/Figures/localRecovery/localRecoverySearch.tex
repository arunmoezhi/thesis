...
\centering
{
	...
	\node (retT) [process, right of=p1, xshift=4cm, text width=1.2cm, minimum width=1cm] {return true};
	\node (retF) [process, left of=p2, xshift=-5cm, text width=1.2cm, minimum width=1cm] {return false};
