...
\centering
{
	\begin{tikzpicture}[scale=\myfigurescaletwo, transform shape]
		...
		\node[text width=5cm] at (12,-9.5) {(d) Thread $B$ executes delete(20) and node $V$ is removed};
		\node[text width=5cm] at (6,-9.5)  {(e) Thread $B$ executes insert(20) and a node $V\prime$ is added. Thread $A$ wakes up and reaches node $V\prime$};
		...
		(12, -4.25) 	edge[->,semithick] node [left, 	outer sep=2pt] 		{\large \texttt del(20)} (12, -5.25)
