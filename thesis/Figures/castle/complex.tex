...
\centering
{
	\begin{tikzpicture}
		...
		\node (x1) 	[rectangle,align=center,minimum size=1cm] at (-7.25,0) 	{target \\ node};
		\node (y1l) [rectangle,align=center,minimum size=1cm] at (-7.8,-3) 		{successor node's \\  parent};
		...
		(-3.25, 0.5) edge[->,semithick, double] node [above, outer sep=3pt] {\large \texttt delete 50} (-0.75, 0.5);
		...
		%% legend
		\draw[->] (0,-6.1) -- (1,-6.1) node[right] {\large ~free edge};
		\draw[->,dotted,thick] (0,-6.6) -- (1,-6.6) node[right] {\large ~locked edge};
		\node [thin, draw=black, align=center, minimum width=5cm, minimum height=1.25cm] at (2,-6.35) {};	
