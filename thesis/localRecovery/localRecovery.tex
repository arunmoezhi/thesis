...
\newcommand{\myinadmissible}{inadmissible}
...
\newcommand{\myinconsistent}{strictly inconsistent}
\newcommand{\mynonconsistent}{inconsistent}
\newcommand{\storedpath}{\Pi}
\newcommand{\prefixpath}[1]{\Pi(#1)}
\newcommand{\mylegal}{legal}
\newcommand{\mykey}{\kappa}
\newcommand{\mylegality}{legal}
\newcommand{\mysafety}{safety}
\newcommand{\MySafety}{Safety}
\newcommand{\injection}{injection}
\newcommand{\action}{execution}
...
\newcommand{\FindStartPoint}{\textsc{FindARestartPoint}}
\newcommand{\FindAdmissible}{\textsc{IsNodeSafe}}
...
In \chaptersref{castle}{icdcn} we described our lock based and lock free algorithms respectively.
...
\input{localRecovery/overview}
\input{localRecovery/description}
\input{localRecovery/proof}
