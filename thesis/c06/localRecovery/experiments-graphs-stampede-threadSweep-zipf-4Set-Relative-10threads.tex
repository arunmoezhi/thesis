...
\centering
\begin{tikzpicture}
	\begin{groupplot}[group style={group size= 4 by 3},height=4.25cm,width=4.25cm,max space between ticks=20,minor tick num=1,tick label style={font=\footnotesize},ymin=0.8,ymax=1.6]
