...
\newcommand{\ICDCN}{\textsc{OUR-LF-IBST}}
\newcommand{\CASTLE}{\textsc{OUR-LB-IBST}}
\newcommand{\CITRUS}{\textsc{RCU-LB-IBST}}
...
\title{\centering {Concurrent Binary Search Trees \\ Design and Optimizations}}
...
\subsection{Lock Based Binary Search Tree}
\input{lockBasedBST}

\subsection{Lock Free Binary Search Tree}
\input{lockFreeBST}
