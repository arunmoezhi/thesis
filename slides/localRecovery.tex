...
\end{frame}
\begin{frame}[c]{Traversal Stack}
\input{figures/stackA1a}
\end{frame}
\begin{frame}[c]{Traversal Stack}
\input{figures/stackA1b}
\end{frame}
\begin{frame}[c]{Traversal Stack}
\input{figures/stackA1c}
\end{frame}
\begin{frame}[c]{Traversal Stack}
\input{figures/stackA1d}
\end{frame}
\begin{frame}[c]{Traversal Stack}
\input{figures/stackA1e}
\end{frame}
...
\input{figures/stackI0}
\end{frame}
\begin{frame}[c]{Search - inconsistent anchor}
\input{figures/stackI1}
\end{frame}
\begin{frame}[c]{Search - inconsistent anchor}
\input{figures/stackI2}
\end{frame}
