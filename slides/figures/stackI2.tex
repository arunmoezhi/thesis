...
\begin{tikzpicture}[scale=0.4, transform shape]
   ...
   \node (s)	[treenode] 										at ([shift=({ \NODEDX, -\NODEDY})]r)     	  {$S$ \\  $\infty$};
	 ...
	 \node (op) [label={left:{\large $search(45)$}}] at ([shift=({-0.5, 0})]w) {};
...
\begin{tikzpicture}[scale=0.3, transform shape]
	...
	\end{tikzpicture}
\caption{Pop upto marked anchor node $X$. Top of stack is now $W$. Examine anchor node $U$. A.oldKey(20) $<$ K(45) $<$ A.newKey(50). Inconsistent anchor}
\end{figure}